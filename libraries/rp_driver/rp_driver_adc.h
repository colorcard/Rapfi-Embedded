#ifndef _rp_driver_adc_h_
#define _rp_driver_adc_h_
 ...
 */
rp_status_t adc_init(const adc_cfg_t *cfg);
 ...
 * @return RP_OK 表示成功，其他值表示失败。
 */
rp_status_t adc_convert(adc_channel_enum channel, uint16_t *raw);
 ...
 * @return RP_OK 表示成功，其他值表示失败。
 */
rp_status_t adc_convert_voltage(adc_channel_enum channel, uint32_t *voltage_mv);

#ifdef __cplusplus
}
#endif

#endif /* _rp_driver_adc_h_ */
