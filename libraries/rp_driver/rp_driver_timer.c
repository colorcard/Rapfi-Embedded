 ...
 */
static rp_status_t timer_pwm_channels_init(TIM_HandleTypeDef *htim,
...
rp_status_t timer_hw_init(timer_index_enum index)
{
  ...
  switch (index) {
    case TIMER_1:
      ...
      if (timer_pwm_channels_init(htim, s_tim1_channels, 4U) != RP_OK) {
        return RP_ERROR;
      }
      {
    ...
    case TIMER_2:
      ...
      if (timer_pwm_channels_init(htim, s_tim2_channels, 4U) != RP_OK) {
        return RP_ERROR;
      }
      HAL_TIM_MspPostInit(htim);
      break;
    ...
    case TIMER_3:
      ...
      if (timer_pwm_channels_init(htim, s_tim3_channels, 4U) != RP_OK) {
        return RP_ERROR;
      }
      HAL_TIM_MspPostInit(htim);
      break;
    ...
    case TIMER_4:
      ...
      if (timer_pwm_channels_init(htim, s_tim4_channels, 4U) != RP_OK) {
        return RP_ERROR;
      }
      HAL_TIM_MspPostInit(htim);
      break;
