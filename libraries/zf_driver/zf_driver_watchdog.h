#ifndef _zf_driver_watchdog_h_
#define _zf_driver_watchdog_h_
 ...
 * @return ZF_OK 表示成功，ZF_INVALID_PARAM 表示超时超出范围，ZF_ERROR 表示 HAL 初始化失败。
