#ifndef _zf_device_w25q128_h_
#define _zf_device_w25q128_h_
 ...
 * @return ZF_OK 表示成功，其他值表示失败。
 */
zf_status_t w25q128_read_jedec_id(uint8_t id[W25Q128_JEDEC_ID_SIZE]);
 ...
 * @return ZF_OK 表示成功，其他值表示失败。
 */
zf_status_t w25q128_read(uint32_t address, uint8_t *data, uint16_t length);

#ifdef __cplusplus
}
#endif

#endif /* _zf_device_w25q128_h_ */
